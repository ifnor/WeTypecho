...
Component({
  ...
  cache: {},
  ready () {
    qq.removeStorageSync('canvasdrawer_pic_cache')
    this.cache = qq.getStorageSync('canvasdrawer_pic_cache') || {}
    this.ctx = qq.createCanvasContext('canvasdrawer', this)
  },
  methods: {
    readyPigment () {
    ...
    startPainting () {
      ...
      this.ctx.draw(false, () => {
        qq.setStorageSync('canvasdrawer_pic_cache', this.cache)
