...
module.exports = {
    ...
    GetAccessCode: function(url) {
        return this.appendAPISEC(API_URL + 'getaccesscode_qq?path=' + url);
    },
    ...
    UserLike:function(openid){
        return this.appendAPISEC(API_URL + 'getuserlikes?&openid=' + openid);
    },
    ...
    Postcomment: function(cid,author,text,parent,icon) {
        return this.appendAPISEC(API_URL + 'addcomment?cid=' + cid + '&author=' + author + '&text=' + text + '&parent=' + parent + '&icon=' + icon + '&mp=qq');
    },
    Login: function(userInfo) {
        return this.appendAPISEC(API_URL + 'qqlogin?code=' + userInfo.code + '&nickname=' + userInfo.nickName + '&avatarUrl=' + userInfo.avatarUrl + '&city=' + userInfo.city + '&country=' + userInfo.country + '&gender=' + userInfo.gender + '&province=' + userInfo.province);
    },
