...
module.exports = {
    ...
    GetAccessCode: function(url) {
        return this.appendAPISEC(API_URL + 'getaccesscode_wx?path=' + url);
    },
    ...
    Postcomment: function(cid,author,text,parent,icon) {
        return this.appendAPISEC(API_URL + 'addcomment?cid=' + cid + '&author=' + author + '&text=' + text + '&parent=' + parent + '&icon=' + icon + '&mp=wx');
    },
    Login: function(userInfo) {
        return this.appendAPISEC(API_URL + 'wxlogin?code=' + userInfo.code + '&nickname=' + userInfo.nickName + '&avatarUrl=' + userInfo.avatarUrl + '&city=' + userInfo.city + '&country=' + userInfo.country + '&gender=' + userInfo.gender + '&province=' + userInfo.province);
    },
